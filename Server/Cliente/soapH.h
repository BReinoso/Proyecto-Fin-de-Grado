...
inline struct ns__sub * soap_new_req_ns__sub(struct soap *soap, int a, int b) { struct ns__sub *_p = soap_instantiate_ns__sub(soap, -1, NULL, NULL, NULL); if (_p) { soap_default_ns__sub(soap, _p); _p->a = a; _p->b = b; } return _p; }

inline struct ns__sub * soap_new_set_ns__sub(struct soap *soap, int a, int b) { struct ns__sub *_p = soap_instantiate_ns__sub(soap, -1, NULL, NULL, NULL); if (_p) { soap_default_ns__sub(soap, _p); _p->a = a; _p->b = b; } return _p; }
...
inline struct ns__subResponse * soap_new_set_ns__subResponse(struct soap *soap, int *result) { struct ns__subResponse *_p = soap_instantiate_ns__subResponse(soap, -1, NULL, NULL, NULL); if (_p) { soap_default_ns__subResponse(soap, _p); _p->result = result; } return _p; }
...
inline struct ns__add * soap_new_req_ns__add(struct soap *soap, int a, int b) { struct ns__add *_p = soap_instantiate_ns__add(soap, -1, NULL, NULL, NULL); if (_p) { soap_default_ns__add(soap, _p); _p->a = a; _p->b = b; } return _p; }

inline struct ns__add * soap_new_set_ns__add(struct soap *soap, int a, int b) { struct ns__add *_p = soap_instantiate_ns__add(soap, -1, NULL, NULL, NULL); if (_p) { soap_default_ns__add(soap, _p); _p->a = a; _p->b = b; } return _p; }
...
inline struct ns__addResponse * soap_new_set_ns__addResponse(struct soap *soap, int *result) { struct ns__addResponse *_p = soap_instantiate_ns__addResponse(soap, -1, NULL, NULL, NULL); if (_p) { soap_default_ns__addResponse(soap, _p); _p->result = result; } return _p; }
