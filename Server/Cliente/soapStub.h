...
public:
	int *result;	/* SOAP 1.2 RPC return element (when namespace qualified) */	/* optional element of type xsd:int */
public:
	int soap_type() const { return 12; } /* = unique type id SOAP_TYPE_ns__subResponse */
};
#endif
...
public:
	...
	int b;	/* required element of type xsd:int */
public:
	int soap_type() const { return 13; } /* = unique type id SOAP_TYPE_ns__sub */
};
#endif
...
SOAP_FMAC5 int SOAP_FMAC6 soap_call_ns__sub(struct soap *soap, const char *soap_endpoint, const char *soap_action, int a, int b, int *result);
